...
SPEC_FIELDS: list[SpecField] = [
    ...
    {"name": "수입자",       "label": "수입자",       "type": "text",
     "desc": "수입업체명. 패키지 뒷면 등에 명시된 경우만 (예: '(주)○○무역')"},
    ...
    {"name": "가로_cm",      "label": "가로 (cm)",    "type": "number", "unit": "cm",
     "desc": "제품 본체의 가로 치수. 이미지 텍스트에 명시된 수치만 인정. 추정 금지. 박스 치수 아님"},
    {"name": "세로_cm",      "label": "세로 (cm)",    "type": "number", "unit": "cm",
     "desc": "제품 본체의 세로/깊이 치수. 명시된 수치만. 박스 치수 아님"},
    {"name": "높이_cm",      "label": "높이 (cm)",    "type": "number", "unit": "cm",
     "desc": "제품 본체의 높이 치수. 명시된 수치만. 박스 치수 아님"},
    {"name": "무게_g",       "label": "무게 (g)",     "type": "number", "unit": "g",
     "desc": "제품 본체의 무게(g). kg 표기는 1000을 곱해 변환. 명시된 수치만. 박스 무게 아님"},
    # 패키지(박스) 치수·무게
    {"name": "박스_가로_cm", "label": "박스 가로 (cm)", "type": "number", "unit": "cm",
     "desc": "패키지(박스) 가로 치수. 명시된 수치만. 추정 금지"},
    {"name": "박스_세로_cm", "label": "박스 세로 (cm)", "type": "number", "unit": "cm",
     "desc": "패키지(박스) 세로/깊이 치수. 명시된 수치만"},
    {"name": "박스_높이_cm", "label": "박스 높이 (cm)", "type": "number", "unit": "cm",
     "desc": "패키지(박스) 높이 치수. 명시된 수치만"},
    {"name": "박스_무게_g",  "label": "박스 무게 (g)",  "type": "number", "unit": "g",
     "desc": "박스 포함 총 무게(g). kg 표기는 1000을 곱해 변환. 명시된 수치만"},
    # 제품 소재/색상
    ...
    {"name": "구성품",       "label": "구성품",       "type": "text",
     "desc": "박스에 포함된 부속품 목록"},
    # 패키지(박스) 소재/색상
    {"name": "박스_재질",    "label": "박스 재질",    "type": "text",
     "desc": "포장재 종류 (예: '종이박스', 'PE백', '블리스터팩', '비닐')"},
    {"name": "박스_색상",    "label": "박스 색상",    "type": "text",
