# -*- coding: utf-8 -*-
"""엠군_상세페이지_검수 테이블 마이그레이션 실행기.

MY_SUPABASE_DB_URL/MY_SUPABASE_POOLER_URL(.env)을 사용해 psycopg2로 DDL 직접 실행.
...
SQL_FILE = Path(__file__).parent / "add_엠군_상세페이지_검수.sql"
