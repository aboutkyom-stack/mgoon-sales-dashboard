...
- [x] Step 1: 결정 로그 md 작성 + PROJECT_STATUS.md 갱신 (이 섹션)
- [ ] Step 2: 동영상 VP 프롬프트 분리 (제품시연 특화)
- [ ] Step 2.5: CLAUDE.md 신규 작성 (자동화 판매 폴더)
- [ ] Step 3: 사용자 검증 (사운드/동작 잡히는지 확인)
- [ ] Step 4: 만족 시 → 이미지 VP C안 + A안 적용
