...
각 항목:
    ...
    desc      : LLM/Claude에 추출 기준을 설명할 때 사용
    unit      : (선택) 'cm', 'g' 등 단위
"""
...
SPEC_FIELDS: list[SpecField] = [
    ...
    {"name": "모델명",       "label": "모델명",       "type": "text",
     "desc": "제품 패키지/본체에 표기된 모델 번호. 없으면 null"},
    {"name": "제조사",       "label": "제조사",       "type": "text",
     "desc": "제조사명. 이미지 텍스트에서 명시적으로 보일 때만"},
    {"name": "수입자",       "label": "수입자",       "type": "text",
     "desc": "수입업체명. 패키지 뒷면 등에 명시된 경우만 (예: '(주)○○무역', '알티엑스 스포츠')"},
    {"name": "원산지",       "label": "원산지",       "type": "text",
     "desc": "원산지/제조국. 이미지에 표기되어 있을 때만"},
    {"name": "사용연령",     "label": "사용연령",     "type": "text",
     "desc": "권장 사용 연령 (예: '3세 이상', '만 6세부터'). 패키지에 표기된 경우만"},
    # 제품 치수·무게 (제품 자체 기준)
    {"name": "가로_cm",      "label": "가로 (cm)",    "type": "number", "unit": "cm",
     "desc": "제품 본체의 가로 치수. 이미지 텍스트에 명시된 수치만 인정. 추정 금지. 포장 치수 아님"},
    {"name": "세로_cm",      "label": "세로 (cm)",    "type": "number", "unit": "cm",
     "desc": "제품 본체의 세로/깊이 치수. 명시된 수치만. 포장 치수 아님"},
    {"name": "높이_cm",      "label": "높이 (cm)",    "type": "number", "unit": "cm",
     "desc": "제품 본체의 높이 치수. 명시된 수치만. 포장 치수 아님"},
    {"name": "무게_g",       "label": "무게 (g)",     "type": "number", "unit": "g",
     "desc": "제품 본체의 무게(g). kg 표기는 1000을 곱해 변환. 명시된 수치만. 포장 무게 아님"},
    # 포장 치수·무게
    {"name": "포장_가로_cm", "label": "포장 가로 (cm)", "type": "number", "unit": "cm",
     "desc": "포장재 가로 치수. 명시된 수치만. 추정 금지"},
    {"name": "포장_세로_cm", "label": "포장 세로 (cm)", "type": "number", "unit": "cm",
     "desc": "포장재 세로/깊이 치수. 명시된 수치만"},
    {"name": "포장_높이_cm", "label": "포장 높이 (cm)", "type": "number", "unit": "cm",
     "desc": "포장재 높이 치수. 명시된 수치만"},
    {"name": "포장_무게_g",  "label": "포장 무게 (g)",  "type": "number", "unit": "g",
     "desc": "포장 포함 총 무게(g). kg 표기는 1000을 곱해 변환. 명시된 수치만"},
    # 제품 소재/색상
    {"name": "재질",         "label": "재질",         "type": "text",
     "desc": "제품 본체의 주 재질 (예: ABS 플라스틱, 알루미늄, 패브릭). 포장재 아님"},
    {"name": "색상",         "label": "색상",         "type": "text",
     "desc": "제품 본체의 주조색. 보조색은 ',' 로 나열. 패키지 색상 아님"},
    {"name": "구성품",       "label": "구성품",       "type": "text",
     "desc": "패키지에 포함된 부속품 목록"},
    # 포장 소재/색상
    {"name": "포장_재질",    "label": "포장 재질",    "type": "text",
     "desc": "포장재 종류 (예: 'OPP봉투', '종이박스', 'PE백', '블리스터팩', '비닐')"},
    {"name": "포장_색상",    "label": "포장 색상",    "type": "text",
     "desc": "패키지의 주조색. 보조색은 ',' 로 나열"},
